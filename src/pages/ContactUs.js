...
const ContactUs = () => {
    ...
    const submitHandler = () => {
        const errorList = formItemList.filter(el => !formData[el]);
        
        if(errorList.length) setError(errorList)
        else {
            console.log(formData);
                // fetcher(reqUrl.postContactForm , {
    ...
    return (
        <div className="contact">
                    ...
                    <div className="contact__form__container">
                        {
                            formItemList.map((item , index) => (
                                <Input
                                    ...
                                    label={FORM_INPUT_LABEL[item][lang]} 
                                    onChange={value => onFormInputChangeHandler(item , value)} />
                            ))
                        }
            ...
            {
                wasSuccessfulSubmission && <div className="contact__successfulSubmitAlert"> 
                    <div className="contact__successfulSubmitAlert__header"> 
